    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'عادی',
                  style: AppTypography.h9.copyWith(color: AppColors.gray2),
                ),
              ),
            ],
          ),
          ...
          Text(
            'فوریت: عادی',
            style: AppTypography.h8.copyWith(color: AppColors.gray2),
          ),
          ...
          Row(
            ...
            children: [
              const Icon(Icons.access_time, size: 14, color: AppColors.gray2),
